...
if(!authentication_groups_pemissions($page_name,"","Y"))
	...
	if (isset($_REQUEST['searchterm']) && !empty($_REQUEST['searchterm'])) {
		$sql = "SELECT b.branch_id, branch_code, b.branch_name, b.branch_neftifsccode, b.branch_micr, b.sub_branch_code, c.city_place, s.suburb_name 
														...
														<tbody>
															  ...
															  ?>
																<tr class="alternate" id="row_<?php echo $row->branch_id; ?>" style="border-bottom:1px solid #ccc">
																	...
																	<td style="border-bottom:1px solid #ccc" align="left" valign="middle" class="formtitle"><?php echo stripslashes($row->sub_branch_code); ?></td>																	    																	
